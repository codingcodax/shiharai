...
function Calendar({
	...
	const mergedClassNames: typeof defaultClassNames = Object.keys(
		...
		(acc, key) => ({
			// biome-ignore lint/performance/noAccumulatingSpread: read-day-picker structure
			...acc,
	...
	const defaultComponents = {
		// biome-ignore lint/correctness/noNestedComponentDefinitions: read-day-picker structure
		Chevron: (props: {
			className?: string;
			size?: number;
			disabled?: boolean;
